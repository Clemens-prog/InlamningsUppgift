...
public class OversattareTestMedFelHantFin3_2 {
    ...
    public OversattareTestMedFelHantFin3_2() {
        ...
        while(!baraStoraBokstaver) {
            ...
            for(int i = 0; i < ord.length(); i++)
            {
                ...
                if(bokstavAscii < 65 || bokstavAscii > 90) {
                    ...
                    System.out.println("Skriv in en morsekodsord där varje morskod motsvarar bokstäverna A-Z:");
                    morIn = scan.nextLine();
                }
            }
        }
   ...
   private char morTilbok(String str)
   {
       ...
       try {
           ...
           System.out.println("Morsekoden fanns ej i HashMappen");
       //throw new RuntimeException(e);
   } catch (Exception e) {
           //throw new RuntimeException(e);
       }
